 ...
 * @version <ver>
 */
@Controller("orderContractController")
@RequestMapping("/contract/order")
public class OrderContractController extends ContractController{
	...
	public ModelAndView toSearch(ContractImpl contractImpl,HttpSession session) {
		contractImpl.setViewPath("contract/order/searchOrderContract");
	...
	public ModelAndView toEdit(ContractImpl contractImpl,HttpSession session) throws Exception {
		contractImpl.setViewPath("contract/order/editOrderContract");
