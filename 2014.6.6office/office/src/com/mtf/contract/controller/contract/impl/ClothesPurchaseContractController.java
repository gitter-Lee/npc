 ...
 * @version <ver>
 */
@Controller("clothesPurchaseContractController")
@RequestMapping("/contract/clothesPurchase")
public class ClothesPurchaseContractController extends ContractController{
	...
	public ModelAndView toSearch(ContractImpl contractImpl,HttpSession session) {
		contractImpl.setViewPath("contract/clothesPurchase/searchClothesPurchaseContract");
	...
	public ModelAndView toEdit(ContractImpl contractImpl,HttpSession session) throws Exception {
		contractImpl.setViewPath("contract/clothesPurchase/editClothesPurchaseContract");
