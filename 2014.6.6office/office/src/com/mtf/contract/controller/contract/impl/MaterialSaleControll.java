...
@Controller("materialSaleController")
@RequestMapping("/contract/materialSale")
public class MaterialSaleControll extends ContractController{
	...
	public ModelAndView toSearch(ContractImpl contractImpl,HttpSession session) {
		contractImpl.setViewPath("contract/materialSale/searchMaterialSaleContract");
	...
	public ModelAndView toEdit(ContractImpl contractImpl, HttpSession session) throws Exception {
		contractImpl.setViewPath("contract/materialSale/editMaterialSaleContract");
